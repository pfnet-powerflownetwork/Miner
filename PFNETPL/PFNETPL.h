...
#define MAX_LITERAL_SIZE 100			// Maximum Length Of Literal In PFNETPL
#define TOKEN_LIST_SIZE 4096			// Maximum Number Of Tokens In PFNETPL Job - TODO: Finalize Size
...
#define MAX_SOURCE_SIZE 1024 * 512		// 512KB - Maximum Size Of Decoded PFNETPL Source Code
...
// Number / Location Of Unsigned Ints To Send To PFNET Node For Validation
...
// Token Type / Literal Value From PFNETPL Source Code
typedef struct {
	int token_id;
	EPL_TOKEN_TYPE type;
	char *literal;
...
// List Of All Tokens In PFNETPL Source Code
typedef struct {
	SOURCE_TOKEN *token;
	int num;
	int size;
